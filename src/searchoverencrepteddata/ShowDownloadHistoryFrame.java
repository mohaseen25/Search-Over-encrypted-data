 ...
 * @author USER
 */
public class ShowDownloadHistoryFrame extends javax.swing.JFrame {
public static String str1[][];
    /**
     * Creates new form ShowDownloadHistoryFrame
     */
    public ShowDownloadHistoryFrame() {
        initComponents();
        String ar[]={"User Name","File Name","Time of Download"};
     
        jTable1.setModel(new javax.swing.table.DefaultTableModel(str1,ar));
    }
    ...
    private void initComponents() {
        ...
        jScrollPane1.setBounds(420, 190, 452, 120);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ShowDownloadHistoryFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ShowDownloadHistoryFrame().setVisible(true);
            }
        });
    }
